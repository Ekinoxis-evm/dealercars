...
export const en = {
  ...
  account: {
    ...
    steps: ["Your name", "How to reach you", "Your finances"],
    firstName: "First name",
    lastName: "Last name",
    phone: "Mobile phone",
    phoneHint: "We confirm your visit by WhatsApp or text.",
    phoneInvalid: "That number does not look right for the country selected.",
    addressSearch: "Street address",
    addressPlaceholder: "Start typing and pick your address",
    line2: "Apartment, unit (optional)",
    county: "County",
    next: "Continue",
    back: "Back",
    finish: "Save",
    doneTitle: "Your file is complete.",
    doneLede: "Everything an agent needs to talk about a car with you. You can change any of it here at any time.",
    edit: "Edit",
