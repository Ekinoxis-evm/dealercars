...
export const en = {
  ...
  account: {
    ...
    signInLede: "Your email and a code, or your passkey. No credit pull to create an account, and no credit score anywhere in this process — we underwrite on capacity, not on a file this market usually does not have.",
    signIn: "Sign in",
    loading: "Loading…",
