...
export const es: Dictionary = {
  ...
  signIn: {
    ...
    sending: "Enviando…",
    note: "Sin contraseña. Te enviamos un enlace y un código por correo; cualquiera de los dos te deja entrar.",
    sentTo: "Lo enviamos a",
    sentHow: "Abre el enlace del correo, o escribe el código aquí.",
    codeLabel: "Código del correo",
    verify: "Entrar",
    verifying: "Verificando…",
    again: "Usar otro correo",
    badEmail: "Ese correo no parece válido.",
    couldNotSend: "No pudimos enviar el correo ahora mismo. Espera un minuto e inténtalo de nuevo.",
    badCode: "Ese código no coincide. Revisa el correo e inténtalo de nuevo.",
  },
  ...
  account: {
    ...
    signInLede: "Sin consulta de crédito para crear la cuenta y sin puntaje de crédito en ningún paso — evaluamos capacidad de pago, no un historial que este mercado casi nunca tiene.",
    signIn: "Iniciar sesión",
    signOut: "Cerrar sesión",
    loading: "Cargando…",
    yourDetails: "Tus datos",
    stepOf: (n: number, total: number) => `Paso ${n} de ${total}`,
    steps: ["Tu nombre", "Cómo contactarte", "Tus finanzas"],
    firstName: "Nombre",
    lastName: "Apellido",
    phone: "Celular",
    phoneHint: "Te confirmamos la cita por WhatsApp o mensaje de texto.",
    phoneInvalid: "Ese número no parece correcto para el país elegido.",
    addressSearch: "Dirección",
    addressPlaceholder: "Empieza a escribir y elige tu dirección",
    line2: "Apartamento, unidad (opcional)",
    county: "Condado",
    next: "Continuar",
    back: "Atrás",
    finish: "Guardar",
    doneTitle: "Tu expediente está completo.",
    doneLede: "Todo lo que un asesor necesita para hablar de un auto contigo. Puedes cambiar cualquier dato aquí cuando quieras.",
    edit: "Editar",
